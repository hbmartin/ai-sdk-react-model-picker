      ...
      <div className="flex h-full flex-col">
        <div className="mb-4 flex items-center gap-2">
          <button
            type="button"
            onClick={onBack}
            className="rounded-full p-1 text-muted transition-colors duration-150 hover:bg-accent hover:text-foreground"
          ...
          <h3 className="text-sm font-semibold text-foreground">Configure Models</h3>
        </div>
