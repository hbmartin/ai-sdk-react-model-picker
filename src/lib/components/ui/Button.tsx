...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = 'inline-flex items-center justify-center rounded-default font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1';
  ...
  const getVariantClasses = () => {
    if (environment === 'vscode') {
      ...
      return {
        primary: 'bg-vscode-button-bg text-vscode-button-fg hover:bg-vscode-button-hover-bg focus:ring-vscode-focus-border',
        secondary: 'bg-vscode-input-bg text-vscode-input-fg hover:bg-vscode-list-hover-bg focus:ring-vscode-focus-border',
        destructive: 'bg-vscode-error text-vscode-button-fg hover:opacity-90 focus:ring-vscode-error',
      };
    } else {
