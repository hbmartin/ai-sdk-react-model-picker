...
export const AzureIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  React.createElement('svg', {
    ...
    React.createElement('path', { d: 'M5.531 5.656L12 2l6.469 3.656v7.312L12 16.625l-6.469-3.657V5.656z', fill: '#0072C6' }),
    React.createElement('path', { d: 'M18.469 12.969L12 16.625v6.375l6.469-3.656v-6.375z', fill: '#0072C6', opacity: '0.8' }),
    React.createElement('path', { d: 'M5.531 12.969v6.375L12 23v-6.375l-6.469-3.656z', fill: '#0072C6', opacity: '0.6' })
  )
);
...
export const SpinnerIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  React.createElement('svg', {
    ...
    React.createElement('path', { fill: 'currentColor', d: 'M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z', opacity: '0.75' })
  )
);
